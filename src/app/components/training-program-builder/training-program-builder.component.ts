...
export class TrainingProgramBuilderComponent implements OnInit {
	...
	constructor(private router: Router, private userService: UserService, private firebase: FirebaseService) {	}

	async ngOnInit() {
		this.trainingProgram.session = await this.userService.getTrainingProgram();
	}
